...
const produtos = [
    ...
    { id: 3, description: 'Notebook Acer Aspire 5 A514-53-59QJ Intel Core I5 8GB 256GB SSD 14 Windows 10', img: 'https://acerstore.vteximg.com.br/arquivos/ids/157506-760-760/A514-53-54_SSD_01.jpg?v=637396805695270000', price: 4000, quantity: 2 }, { id: 4, description: 'Notebook Samsung Book E30 15.6" Intel® Core™ i3-10110U 4GB/1TB Windows 10 Home', img: 'https://d3bkgvrq5dqryp.cloudfront.net/Custom/Content/Products/34/17/3417_product-00079815_m39_637400210574011388', price: 3000, quantity: 0 }, 
...
router.get('/:id', (req: Request, res: Response) => {
    const produto= produtos.find((produto) => Number(produto.id)  === Number(req.params.id));
...
router.put('/:id', (req: Request, res: Response) => {
    const produtoIndex= produtos.findIndex((produto) => Number(produto.id)  === Number(req.params.id));
    if (produtoIndex === -1){
        return res.status(400).send({ message: "Produto não encontrado!"});
    }
    produtos[produtoIndex] = req.body;
